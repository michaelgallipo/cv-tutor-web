...
skip_before_action :verify_authenticity_token
  ...
  def update
    @tutor = Tutor.find(params[:id])
      ...
      @tutor.phone_visible = params[:phone_visible] 
      @tutor.about = params[:about] || @tutor.about
      @tutor.math = params[:math] 
      @tutor.reading = params[:reading] 
      @tutor.science = params[:science] 
      @tutor.social_studies = params[:social_studies]
      @tutor.special_needs = params[:special_needs] 
      @tutor.spelling = params[:spelling] 
      ...
      @tutor.accept_new = params[:accept_new]

      if params[:password] != ""
        @tutor.password = params[:password] 
        @tutor.password_confirmation = params[:password_confirmation] 
      end
